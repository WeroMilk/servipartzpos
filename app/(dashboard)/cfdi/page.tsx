      ...
      <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden px-2 sm:px-4 py-2 sm:py-3 pb-[max(0.5rem,env(safe-area-inset-bottom,0px))] sm:pb-3" style={{ WebkitOverflowScrolling: "touch" }}>
        <div className="max-w-4xl mx-auto w-full space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {/* Box izquierda: Información fiscal */}
            <section className="bg-apple-surface rounded-xl sm:rounded-2xl border border-apple-border shadow-sm overflow-hidden">
              ...
              <div className="p-3 sm:p-4 space-y-2">
                <div>
                  <label className="block text-xs font-medium text-apple-text mb-0.5">RFC</label>
                  <input
                    type="text"
                    value={cfdiForm.rfc}
                ...
                <div>
                  <label className="block text-xs font-medium text-apple-text mb-0.5">Razón social</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs font-medium text-apple-text mb-0.5">Régimen fiscal</label>
                  <select
                ...
                <div>
                  <label className="block text-xs font-medium text-apple-text mb-0.5">Código postal</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs font-medium text-apple-text mb-0.5">Domicilio fiscal</label>
                  <input
                    type="text"
            ...
            <section className="bg-apple-surface rounded-xl sm:rounded-2xl border border-apple-border shadow-sm overflow-hidden">
              ...
              <div className="p-3 sm:p-4 space-y-2">
                <div>
                  <label className="block text-xs font-medium text-apple-text mb-0.5">URL del PAC (ej. Facturama)</label>
                  <input
                    type="url"
                ...
                <div>
                  <label className="block text-xs font-medium text-apple-text mb-0.5">Usuario PAC</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-xs font-medium text-apple-text mb-0.5">Contraseña PAC</label>
                  <input
                    type="password"
          ...
          <div className="flex justify-center">
            <button
              type="button"
              onClick={handleSave}
              className="px-8 py-3 bg-apple-accent text-white text-sm font-semibold rounded-xl hover:opacity-90 transition-opacity"
            >
